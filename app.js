    ...
    function loadScript(src) {
        return new Promise((resolve, reject) => {
            ...
            s.onload = () => resolve();
            s.onerror = (e) => { console.warn('依赖加载失败：' + src, e); reject(e); };
    ...
    function openModal(data) {
        ...
        try {
            ...
            }).catch((e) => { console.warn('HanziWriter 加载失败，跳过田字格渲染：', e); });
        } catch (e) {
